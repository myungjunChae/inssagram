...
class InfoSecondFragment : BaseFragment<FragmentInfoDefaultBinding>() {
    ...
    override fun onCreateView(
        ...
        binding.imageView.apply{
            background = context.getDrawable(R.drawable.info_image_2)
        }

        binding.textView.text = ResourceUtil(context!!).convertHtml(R.string.second_info_text)
